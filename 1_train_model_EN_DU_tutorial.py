...
from transformer.models import TransformerModel, EncoderModel, DecoderModel, TransformerEncDecModel
...
decoder = DecoderModel(dec_vocab_size, dec_seq_length, h, d_k, d_v, d_model, d_ff, n, dropout_rate)
training_model = TransformerEncDecModel(encoder, decoder)
